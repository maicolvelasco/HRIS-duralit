  ...
  <AuthenticatedLayout>
    <template #header>
      <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 flex items-center gap-2">
        ...
        Mis Sobretiempos
        <span class="ml-auto text-lg font-normal text-gray-600 dark:text-gray-400">
          Horas Disponibles: {{ totalDisponible }} hrs
        </span>
      </h2>
    </template>
      ...
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="bg-white dark:bg-slate-800 shadow-md rounded-xl overflow-hidden">
          ...
          <div class="md:hidden space-y-4 p-4">
            <div v-for="ot in overtimes" :key="ot.id" class="bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-gray-700 rounded-xl p-4 shadow">
              ...
              <div class="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                <div>Usuario: {{ ot.user.codigo }} - {{ ot.user.nombre }} {{ ot.user.apellido }}</div>
