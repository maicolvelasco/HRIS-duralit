...
const props = defineProps({ show: Boolean, authorization: Object });
...
function submit() {
  form.put(route('settings.authorizations.update', props.authorization.id), {
    preserveScroll: true,
